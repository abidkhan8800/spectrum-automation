...
public class CFCModeRecipeCreation {

	@Test
	public void dModeRecipeCreation()throws Exception {
		...
		Sheet s = workbook.getSheet("cfcModeRecipeCreation");
		...
		for(int i=0;i<a.size();i++) {
			...
			if(a.get(i).equals("auxPumpDropDown")) {
				String keyword =(String) a.get(i);
				String data =   (String) a.get(i+1);
				String objectName = (String) a.get(i+2);
				String runmode = (String) a.get(i+3);
				...
				System.out.println(runmode);
				if(runmode.equals("yes")) {
					key.auxPumpDropDown(data,objectName);
				}
			}
